			...
			<main className="text-white ml-10 mr-10">
				<div className="lg:grid lg:auto-cols-auto lg:pt-10">
					<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-2 lg:w-5/12 lg:flex lg:flex-wrap lg:w-11/12">
						...
						<div className=" col-start-1 col-end-3 row-start-3 row-end-4 sm:w-6/12 ml-10  mb-10 mt-8 lg:col-end-2 lg:row-start-2 lg:row-end-3 w-56">
						...
						<div className="flex col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-lg font-inter">
							<details>
