				...
				<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
					...
					<div className="col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-sm font-inter">
						<details>
							...
							<div>
								<p>Calories: 500</p>
								<p>Total fat: 22g</p> <p>Saturated fat: 6g</p>
								<p> Trans fat: 0g</p> <p>Cholesterol: 70mg</p>
							</div>
							<p>Sodium: 1180mg</p> <p>Total carbohydrate: 47g</p>
							<p>Dietary fiber: 4g Sugars: 6g Protein: 29g</p>
                            <p></p>
						</details>
