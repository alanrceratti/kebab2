		...
		<section>
			<main className="text-white ml-10 mr-10">
				<div className="lg:grid lg:auto-cols-auto lg:pt-10">
					<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-4 lg:w-5/12 lg:flex lg:flex-wrap lg:w-11/12">
						<div className="m-5 pt-32 col-start-1 col-end-3 row-start-1 row-end-2 sm:w-2/3">
