		...
		<section>
			<main className="text-white ml-10 mr-10">
				<div className="md:grid md:auto-cols-auto md:pt-10">
					<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-4 md:w-5/12">
						...
						<div className=" col-start-1 col-end-3 row-start-3 row-end-4 mb-10 mt-8 md:col-end-2 md:row-start-2 md:row-end-3">
						...
						<div className="flex col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-md font-inter">
							<details>
                            ...
                            "
								>
									...
									<div className="text-center mt-2">
										<Link href={"/location"}>
											<button className="h-8 w-32 md:h-16 md:w-60 text-base bg-green text-black font-bold transition-all ease-in-out duration-500 hover:bg-black hover:border hover:border-green hover:text-green">
												ORDER NOW
											</button>
										</Link>
									</div>
					...
					<div className="hidden md:block md:col-start-2 md:col-end-3 md:row-start-1 md:row-end-3 mt-8">
						<Image
							className=" hidden md:flex md:max-w-[145px] md:w-full  max-h-[159px] "
							src="/about/dot.svg"
							alt="dots_svg"
					...
					<div className="md:col-start-3 md:col-end-4">
						<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
							...
							<thead>
								<div className="col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-md font-inter">
