	...
	return (
		<section>
			<main>
				...
				<div>
					<Image src="/food/gyros.png" alt="gyros" width={300} height={300} />
					<div>
						<p>£7.99</p>
				...
				<di>
					...
					<div>
						<img src="/about/souvlaki.png" alt="Souvlaki" />
						<h2>Souvlaki</h2>
						<p>
					...
					<div>
						<img src="/about/salad.png" alt="Salad" />
						<h2>Greek Salad</h2>
						<p>
							Greek grilled souvlaki skewers served with pita,
							veggies, and tzatziki sauce.
					...
					<div>
						<img src="/about/burger.png" alt="Burger" />
						<h2>Burger</h2>
						<p>
							Greek grilled souvlaki skewers served with pita,
							veggies, and tzatziki sauce.
