...
sm:w-[400px] md:w-[600px] m-auto  "
					...
					<div className="hidden lg:block lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-3 mt-8">
						<Image
							className=" hidden lg:flex lg:max-w-[145px] lg:w-full  max-h-[159px] absolute  "
							src="/about/dot.svg"
							alt="dots_svg"
							width={300}
							height={300}
						...
						<div
							className="col-start-1 col-end-2 row-start-1 row-end-4 relative w-[400px] h-[700px]  m-auto
                            bg-white"
						>
							<Image
								src="/food/gyros.png"
