			...
			<main className="text-white ml-10 mr-10">
				<div className="lg:grid lg:auto-cols-auto lg:pt-10">
					<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-2 lg:flex lg:flex-wrap lg:w-11/12">
						...
						<div className=" col-start-1 col-end-3 row-start-3 row-end-4 sm:w-6/12  mt-8 lg:col-end-2 lg:row-start-2 lg:row-end-3 ">
...
sm:w-[400px] md:w-[600px] m-auto  "
								>
									...
									/>
									<div>
										<p className="absolute left-10 md:left-16 bottom-12 text-xs text-gray-500">
											*Illustrative image
										</p>
										<p className="font-inter font-extrabold text-lg text-center absolute top-0 md:ml-16 ">
											Only
