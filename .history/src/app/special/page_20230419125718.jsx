	...
	return (
		<section>
			<main className="text-white ml-10 mr-10">
				<div
					className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10 
                sm:grid-cols-3 sm:pt-10"
				>
					<div
						className="pt-32 col-start-1 col-end-3 row-start-1 row-end-2 
                    sm:col-end-2"
					>
					...
					<div>
						<details className="flex col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-sm font-inter">
					...
					<div
						className="col-start-1 col-end-3 row-start-2 row-end-3 relative
                       sm:col-start-2 sm:col-end-3 sm:row-start-1 sm:row-end-3"
					>
						<Image
							src="/food/gyros.png"
							alt="gyros"
...
<div>
				<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
					<div className="pt-32 col-start-1 col-end-3 row-start-1 row-end-2 ">
						...
						<p className="mt-4">
							Souvlaki is a Greek dish made of grilled skewered
							meat (usually pork, chicken, or lamb) and
							vegetables, served with pita bread, tomatoes,
							onions, and tzatziki sauce.
						</p>
					</div>
					<div className=" col-start-1 col-end-3 row-start-3 row-end-4">
						...
						<p>
							...
							marinade) Lemon juice Garlic Oregano Salt Pepper
							Skewers Pita bread Tomatoes Onions Tzatziki sauce
							(yogurt, cucumber, garlic, dill, lemon juice, salt)
						</p>
					</div>
					<thead>
						<div className="col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-sm font-inter">
							<details className="flex">
								...
								<table className="ml-1 w-44">
									...
									<tr className="border-2 text-gray-400">
										<td>Cholesterol: </td>
										<td className="text-right">50mg</td>
									</tr>
									<tr className="border-2 text-gray-400">
										<td>Sodium: </td>
										<td className="text-right">600mg</td>
									</tr>
									<tr className="border-2 text-gray-400">
										<td>Carbohydrate:</td>
									...
									<tr className="border-2 text-gray-400">
										<td>Protein:</td>
										<td className="text-right">32g</td>
									</tr>
								</table>
							</details>
						</div>
					...
					<div className="col-start-1 col-end-3 row-start-2 row-end-3 relative ">
						...
						<div>
							...
							<p className="font-inter font-extrabold text-lg text-center absolute top-0 ml-2 ">
								Only <span className="text-green ">£6.99</span>
							</p>
						</div>
						<div className="text-center mt-2">
							<Link href={"/location"}>
				...
				<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
					<div className="pt-32 col-start-1 col-end-3 row-start-1 row-end-2 ">
						...
						<p className="mt-4">
							Greek moussaka is a traditional dish made of layers
							of eggplant, spiced ground meat (usually lamb), and
							a creamy béchamel sauce. It is baked until golden
							brown and served hot as a hearty and flavorful meal.
						</p>
					</div>
					<div className=" col-start-1 col-end-3 row-start-3 row-end-4">
						<h1 className="text-2xl font-inter font-bold mb-5">
						...
						<p>
							Eggplant Ground meat (usually lamb or beef) Onion
							Garlic Tomato sauce or paste Red wine (optional)
							Cinnamon Allspice Olive oil Flour Milk Nutmeg
						...
						<div className="col-start-1 col-end-3 row-start-4 row-end-5 text-gray-500 text-sm font-inter">
							<details className="flex">
								...
								<table className="ml-1 w-44">
									<tr className="border-2 text-gray-400 ">
										<td>Calories:</td>
										<td className="text-right">450kcal</td>
									</tr>
									<tr className="border-2 text-gray-400">
										<td>Total Fat:</td>
									...
									<tr className="border-2 text-gray-400">
										<td>Cholesterol: </td>
										<td className="text-right">110mg</td>
									</tr>
									<tr className="border-2 text-gray-400">
										<td>Sodium: </td>
										<td className="text-right">550mg</td>
									</tr>
									<tr className="border-2 text-gray-400">
										<td>Carbohydrate:</td>
										<td className="text-right">28g</td>
