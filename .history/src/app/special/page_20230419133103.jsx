		...
		<section>
			<main className="text-white ml-10 mr-10">
				<div className="sm:grid sm:grid-cols-3 sm:pt-10">
					<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-4 ">
						...
						<div className=" col-start-1 col-end-3 row-start-3 row-end-4 mb-10 sm:col-end-2 sm:row-start-2 sm:row-end-3">
						...
						<div className="sm:col-start-2 sm:col-end-3 sm:row-start-1 sm:row-end-3">
							...
							<div className="col-start-1 col-end-2 row-start-2 row-end-3 relative w-[300px]">
								<Image
									src="/food/gyros.png"
									alt="gyros"
									width={500}
					...
					<div className="sm:col-start-3 sm:col-end-4">
						<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
							...
							<div className="col-start-1 col-end-3 row-start-2 row-end-3 relative justify-center ">
								<Image
