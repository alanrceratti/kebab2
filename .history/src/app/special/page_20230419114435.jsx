			...
			<main className="text-white ml-10 mr-10">
				<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
					...
					<div className="col-start-1 col-end-3 row-start-2 row-end-3 relative ">
						...
						<div className="">
							<Link href={"/location"}>
								<button className="h-8 w-32 sm:h-16 sm:w-60 text-base bg-green text-black text-center font-bold transition-all ease-in-out duration-500 hover:bg-black hover:border hover:border-green hover:text-green">
									ORDER NOW
								</button>
							</Link>
						</div>
