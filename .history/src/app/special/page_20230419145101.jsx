						...
						>
							...
							<div>
								...
								<p className="font-inter font-extrabold text-lg text-center absolute bottom-36 ml-2 ">
									...
									<img src="/our-special/plus.svg" className="h-8 w-32 lg:h-16  text-base bg-green text-black font-bold transition-all ease-in-out duration-500 hover:bg-black hover:border hover:border-green hover:text-green"/>
