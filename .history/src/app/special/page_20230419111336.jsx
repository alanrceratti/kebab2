...
const OurSpecial = () => {
	return (
		<section>
            	{/* MAIN section exclusive for mobile devices bigger than mobile */}
			<main className="text-white ml-10 mr-10 sm:hidden">
			...
			{/* Section for devices bigger than mobile */}
			<main className="text-white ml-10 mr-10 hidden">
				<div className=" grid auto-cols-1 auto-rows-auto grid-flow-row gap-10  ">
					<div className="pt-32 col-start-1 col-end-3 row-start-1 row-end-2 ">
						<h1 className="text-6xl font-aclonica">
							GY<span className="text-green">ROS</span>
