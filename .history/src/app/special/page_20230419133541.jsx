				...
				<div className="sm:grid sm:grid-cols-3 sm:pt-10">
					<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-4 ">
						...
						<div className="sm:col-start-2 sm:col-end-3 sm:row-start-1 sm:row-end-3">
							...
							<div className="col-start-1 col-end-2 row-start-2 row-end-3 relative w-[320px]  m-auto">
								<Image
									src="/food/gyros.png"
									alt="gyros"
									width={500}
								...
								<div>
									...
									<p className="font-inter font-extrabold text-lg text-center absolute top-0 ml-2 mb-5 ">
										Only{" "}
