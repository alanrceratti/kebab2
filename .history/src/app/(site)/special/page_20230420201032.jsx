...
function OurSpecial() {
	...
	//this function is for when user click in the offer, then it gets the correct ID to call the FetchDocument function with the ID 
								...
								<div className="hidden lg:block lg:col-start-3 col-end-4 mt-24 h-[668px]  overflow-scroll">
									{data.map((offer) => {
										return (
											...
											>
												<div className=" bg-gray-200 active">
													<div
														className={`${
															newDocument ===
															documentId
																? "w-56 active current:bg-blue-600"
																: "w-56 bg-green"
														}`}
													>
														<Image
