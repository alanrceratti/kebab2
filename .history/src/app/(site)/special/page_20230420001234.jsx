								...
								<div>
									<div className="lg:hidden">
										...
										<div className="col-start-1 col-end-2 row-start-2 row-end-3 relative w-[320px] h-[320px] sm:w-[400px] md:w-[600px] m-auto  ">
											...
											/>
											<div>
												<p className="absolute left-4 sm:left-12 md:left-16 md:ml-24  bottom-4  text-xs text-gray-500">
													*Illustrative image
												</p>
												<p className="font-inter font-extrabold text-lg text-center absolute top-0 left-4 sm:left-12 md:left-16 md:ml-24 ">
													Only
													<span className="text-green ">
														£ {offer.price}
													</span>
