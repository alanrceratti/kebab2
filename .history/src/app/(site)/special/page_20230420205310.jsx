											...
											>
												...
												>
													...
													<div className="basis-1/2 ml-4">
														...
														<h3 className={`${offer._id === selectedOffer ? "text-slate-300 text-sm mb-2" :" text-gray-500 text-sm mb-2" }`}>
															{
																offer.short_description
															}
														</h3>
														<h4 className={`${offer._id === selectedOffer ? "text-slate-300 font-light font-inter" : text-black font-light font-inter}`}>
															£ {offer.price}
														</h4>
													</div>
												</div>
