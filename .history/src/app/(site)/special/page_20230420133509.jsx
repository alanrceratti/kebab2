...
function OurSpecial() {
	...
	return (
		<section>
			{data.map((offer) => {
				return (
					<div className="text-white ml-10 mr-10" key={offer._id}>
						<div className="lg:grid lg:auto-cols-auto lg:pt-10">
							<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-2 lg:flex lg:flex-wrap lg:w-11/12">
								<div className=" pt-32 col-start-1 col-end-3 row-start-1 row-end-2 mb-8 sm:w-8/12 ">
									<h1 className="text-5xl font-aclonica bg-gradient-to-r from-white from-0%  via-white via-50% via-amber-700 via-50% to-yellow-400 to-100% bg-clip-text text-transparent">
										{offer.name}
									</h1>
								...
								<div>
									<div className="lg:hidden">
										...
										<div className="col-start-1 col-end-2 row-start-2 row-end-3 relative w-[280px] h-[280px] sm:w-[400px] md:w-[600px]   ">
											<Image
												src={offer.image}
												alt={offer.image.alt}
												width={300}
												height={300}
												className="rounded-xl aspect-square object-cover object-right-top ml-0 mr-0 "
											/>
											<div>
