...
import { getStaticProps } from "../../../../sanity/sanity-utils";
import { useEffect } from "react";
import { useState } from "react";
import useMedia from "@/hooks/useMedia";
import { offersQuery } from "../../../../sanity/sanity-utils";
...
function OurSpecial() {
	...
	async function fetchData() {
		try {
			const offers = await getStaticProps();
			const document = await getStaticProps(id);
			setData(offers);
