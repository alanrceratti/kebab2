					...
					<section>
						<div className="text-white ml-10 mr-10  before:">
							<div className="lg:grid lg:auto-cols-auto lg:pt-10 ">
								...
								<div className="hidden lg:block lg:col-start-2 col-end-3 mt-24 w-[530px] m[pr-4">
									<Image
										src={
											data && newOffers.length < !0
												? data[0]?.image
								...
								<div className="hidden lg:block lg:col-start-3 col-end-4 mt-24 h-[668px]  overflow-scroll">
									{data.map((offer) => {
										return (
											<div
												key={offer._id}
												className="w-80 pb-4 first:pt-4  bg-green"
											>
												<div
													className={`${
														offer._id ===
												...
												>
													<div className=" bg-gray-200   ">
														<Image
															...
															width={150}
															height={200}
															className="rounded-xl aspect-[3/4] cursor-pointer   "
														/>
													</div>
