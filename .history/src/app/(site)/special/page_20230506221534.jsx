...
function OurSpecial() {
	...
	const mobile = useMedia("(min-width: 1150px)");
	const mobile2 = useMedia("(max-width: 1280px)");
	const mobile3 = useMedia("(min-width: 1380px)");
					...
					<section>
						<div className="text-white ml-10 mr-10  before:">
							<div className="md:grid md:auto-cols-auto md:pt-10 ">
								...
								<div
									className={`hidden md:block md:col-start-2 col-end-3 mt-24 md:w-[440px] lg:w-[540px]   relative`}
								>
									<InViewSectionDown>
										<Image
											src={
