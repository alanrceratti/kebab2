			...
			<main className="text-white ml-10 mr-10">
					...
					>
						<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-2 lg:flex lg:flex-wrap lg:w-11/12">
							<div className=" pt-32 col-start-1 col-end-3 row-start-1 row-end-2 mb-8 sm:w-8/12 ">{projects.map((project) => (
								<h1 className="text-6xl font-aclonica " key={project._id}>
									{project.name}
								</h1>
