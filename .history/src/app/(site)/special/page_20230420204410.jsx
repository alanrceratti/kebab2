					...
					<section>
						<div className="text-white ml-10 mr-10  before:">
							<div className="lg:grid lg:auto-cols-auto lg:pt-10 ">
								...
								<div className="hidden lg:block lg:col-start-2 col-end-3 mt-24 w-[530px] ">
									<Image
										src={
											data && newOffers.length < !0
												? data[0]?.image
								...
								<div className="hidden lg:block lg:col-start-3 col-end-4 mt-24 h-[668px]  overflow-scroll">
									{data.map((offer) => {
										return (
											<div
												key={offer._id}
												className="w-80 pb-4 first:pt-4 bg-slate-300  "
											>
												<div
													className={`${
														offer._id ===
														selectedOffer
															? " opacity-100 flex flex-row  "
															: " flex flex-row "
													}`}
												>
													<div className="   ">
														<Image
															...
															width={150}
															height={200}
															className="rounded-xl aspect-[3/4] cursor-pointer ml-2 hover:opacity-75  "
														/>
													</div>
													<div className="basis-1/2 ml-4">
														<h2 className="text-black font-inter font-black capitalize mb-2 ">
															{offer.name}
														</h2>
														...
														<h4 className="text-black font-light font-inter">
															£ {offer.price}
														</h4>
													</div>
												</div>
