					...
					<section>
						<div className="text-white ml-10 mr-10  before:">
							<div className="lg:grid lg:auto-cols-auto lg:pt-10 ">
								<div className="lg:block lg:grid-cols-1 ">
									<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-2 lg:grid lg:grid-flow-col lg:w-11/12">
										<div className=" pt-32 col-start-1 col-end-3 row-start-1 row-end-2 mb-8 sm:w-8/12 lg:w-auto ">
										...
										<div className=" col-start-1 col-end-3 row-start-3 row-end-4 sm:w-8/12  mt-8 lg:col-end-2 lg:row-start-2 lg:row-end-3 lg:w-auto ">
											<h1 className="text-2xl font-inter font-bold mt-4 ">
												What&apos;s
												<span className="text-green">
													inside
												</span>
								...
								<div className="hidden lg:block lg:col-start-2 col-end-3 mt-24 w-[550px] ">
									<Image
										src={
											data && newOffers.length < !0
												? data[0]?.image
								...
								<div className="hidden lg:block lg:col-start-3 col-end-4 mt-24 h-full overflow-scroll">
									{data.map((offer) => {
										return (
											<div
												key={offer._id}
											...
											>
												<div className="w-56 bg-gray-200 target:bg-blue-600">
													<Image
														onClick={handleClick}
														data-id={offer._id}
														key={offer._id}
