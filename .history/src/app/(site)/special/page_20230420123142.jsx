...
function OurSpecial() {
	...
	async function fetchOffers() {
		const newOffer = await getOffers();
		setNewOffers(newOffer);
	}
									...
									<table className="ml-1 w-44">
										<tbody>
											...
											<tr className="border-2 text-gray-400">
												<th>Sugars:</th>
												<td className="text-right">
													{offer.nutritional.sugar}g
												</td>
											</tr>
											<tr className="border-2 text-gray-400">
												<th>Protein:</th>
												<td className="text-right">
													{offer.nutritional.protein}g
												</td>
											</tr>
										</tbody>
									</table>
