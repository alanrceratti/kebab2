					...
					<main className="text-white ml-10 mr-10" key={offer._id}>
						<div className="lg:grid lg:auto-cols-auto lg:pt-10">
							<div className=" grid grid-cols-1 auto-rows-auto grid-flow-row gap-2 lg:grid-cols-3  lg:w-11/12">
								...
								<div className="hidden lg:grid pt-32 col-start-2 col-end-3 row-start-1 row-end-5 mb-8 sm:w-8/12 ">
									<Image
										src={offer.image}
										alt={offer.image.alt}
										width={500}
										height={500}
										className="rounded-xl m-auto aspect-square object-cover object-right-top w-[500px] "
									/>{" "}
								</div>
							</div>
						</div>
