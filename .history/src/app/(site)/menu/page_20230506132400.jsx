			...
			<div className="px-12 pt-[213px]">
				...
				<main>
					<section className="grid grid-cols-2 auto-rows-auto m-16">
						<h1 className="font-aclonica text-6xl row-start-1 row-en col-start-1 col-end-3 text-center">
							Souvlakis/Wraps
						</h1>
						<div className="flex justify-between w-1/2 row-span-2 col-start-1 col-end-2">
