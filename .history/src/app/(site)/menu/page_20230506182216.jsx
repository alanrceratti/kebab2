		...
		<div className="text-white block h-full pb-10 justify-center ">
				...
				<nav>
					<ul
						className={`flex justify-between ${
							!mobile ? "mx-40" : "mx-8"
						} mt-16 font-inter font-extrabold m-4`}
					>
						<li>
						...
						<li>
							<a href="#2" className="cursor-pointer m-4">
								Box Meals
							</a>
						</li>
						<li>
							<a href="#3" className="cursor-pointe m-4r">
								Extras/Sides
							</a>
						</li>
						<li>
			...
			>
				<main className="block m-16 ">
					...
					>
						<h1 className="font-aclonica text-2xl row-start-1 row-end-2 col-start-1 col-end-4 text-center mb-4 pt-10 md:text-6xl">
							Souvlakis/Wraps
						</h1>
