		...
		<div className="text-white block h-full pb-10 justify-center ">
			...
			>
				<main className="block m-4 md:m-16">
					<section
						...
						className={`${
							!media
								...
								: "grid grid-cols-1 auto-rows-auto mt-8 "
						}`}
					>
						<h1 className="font-aclonica text-4xl row-start-1 row-end-2  sm:row-start-1 sm:row-end-2 sm:col-start-1 sm:col-end-4 text-center mb-4 pt-10 md:text-6xl">
							Souvlakis/Wraps
						</h1>
						<div className="  w-full row-start-2 row-end-3 sm:row-start-2 sm:row-end-3 sm:col-start-1 sm:col-end-2 ">
							<div className="inline justify-between font-inter text-base">
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full row-start-3 row-end-4 sm:row-start-3 sm:row-end-4 sm:col-start-1 sm:col-end-2`}
						>
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-4 sm:row-end-5 sm:col-start-1 sm:col-end-2`}
						>
							<div className="flex justify-between font-inter text-base">
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-5 sm:row-end-6 sm:col-start-1 sm:col-end-2`}
						>
							<div className="flex justify-between font-inter text-base">
						...
						{!media ? (
							<span className="border-l-2 h-full w-auto border-green  sm:col-start-2 sm:col-end-3 sm:row-start-2 sm:row-end-6  "></span>
						) : null}
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-2 sm:row-end-3 sm:col-start-3 sm:col-end-4`}
						>
							<div className="flex justify-between font-inter text-base">
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-3 sm:row-end-4 sm:col-start-3 sm:col-end-4`}
						>
							<div className="flex justify-between font-inter text-base">
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-4 sm:row-end-5 sm:col-start-3 sm:col-end-4`}
						>
							<div className="flex justify-between font-inter text-base">
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-5 sm:row-end-6 sm:col-start-3 sm:col-end-4`}
						>
							<div className="flex justify-between font-inter text-base">
					...
					>
						<h1 className="font-aclonica text-6xl sm:row-start-1 sm:row-end-2 sm:col-start-1 sm:col-end-4 text-center ">
							Box Meals
						</h1>
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-2 sm:row-end-3 sm:col-start-1 sm:col-end-2`}
						>
							<div className="flex justify-between font-inter text-base">
								<h2>The Cypriot</h2>
								<p>£7.50</p>
						...
						<div
							className={`${
								media ? "mt-8" : ""
							} w-full sm:row-start-3 sm:row-end-4 sm:col-start-1 sm:col-end-2`}
						>
							<div className="flex justify-between font-inter text-base ">
						...
						{!media ? (
							<span className="border-l-2 h-full w-auto border-green m-auto  sm:col-start-2 sm:col-end-3 sm:row-start-2 sm:row-end-4  "></span>
						) : null}
						<div
							className={`${
								media ? "mt-8" : ""
					...
					>
						...
						<span class="block border-l-2 border-green my-0 mx-auto sm:col-start-2 sm:col-end-3 sm:row-start-2 sm:row-end-6 "></span>
