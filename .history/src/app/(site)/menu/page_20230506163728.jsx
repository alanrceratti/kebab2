		...
		<div className="text-white block h-full pb-10 justify-center">
			...
			<nav>
				<ul className="flex justify-between mx-40 mt-16 font-inter font-extrabold ">
					<li>
						<a href="#1" className="cursor-pointer">Souvlakis/Wraps</a>
					</li>
					<li>
						<a href="#2" className="cursor-pointer">Box Meals</a>
					</li>
					<li>
						<a href="#3" className="cursor-pointer">Extras/Sides</a>
					</li>
					<li>
						<a href="#1" className="cursor-pointer">Drinks</a>
					</li>
				</ul>
			</nav>
