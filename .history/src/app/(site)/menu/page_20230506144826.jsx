			...
			<div className="px-12 pt-[213px]">
				...
				<main className="block m-16 ">
					<section className="grid grid-cols-6 auto-rows-auto gap-4 mb-16 ">
						...
						<div className="  w-full row-start-2 row-end-3 col-start-4 col-end-4 ">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-3 row-end-4 col-start-4 col-end-4">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-4 row-end-5 col-start-4 col-end-4">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-5 row-end-6 col-start-4 col-end-4">
							<div className="flex justify-between font-inter text-base">
