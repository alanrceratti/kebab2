		...
		<div className="text-white flex flex-col lg:flex-row h-full pb-10 desktop:justify-center">
			...
			<div className="px-12 pt-[213px]">
				...
				<main className="block m-16 ">
					...
					<section className="grid grid-cols-3 auto-rows-auto gap-4 mb-16 ">
						<h1 className="font-aclonica text-6xl row-start-1 row-end-2 col-start-1 col-end-8 text-center ">
							Extras/Sides
						</h1>
						<div className="  w-full row-start-2 row-end-3 col-start-1 col-end-4  ">
						...
						<div className="border-l-2 h-full w-[auto] border-green m-auto  col-start-4 col-end-5 row-start-2 row-end-6  "></div>
						<div className="  w-full row-start-2 row-end-3 col-start-5 col-end-8 ">
							<div className="flex justify-between font-inter text-base">
								<h2>Tzatziki dip</h2>
								<p>£2.00</p>
