...
const Menu = () => {
	...
	return (
		<div className="text-white block h-full pb-10 justify-center ">
			...
			>
				<div className="absolute top-0 left-0 w-full h-full mt-80 left-0 right-0 bg-gray-200 opacity-20"></div>
				<div className="relative bg-[url('/menu/menu.png')] -mt-0 left-0 right-0 bg-cover"></div>
