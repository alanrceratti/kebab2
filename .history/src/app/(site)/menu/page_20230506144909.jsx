		...
		<div className="text-white flex flex-col lg:flex-row h-full pb-10 desktop:justify-center">
			...
			<div className="px-12 pt-[213px]">
				...
				<main className="block m-16 ">
					<section className="grid grid-cols-6 auto-rows-auto gap-4 mb-16 ">
						...
						<span className="border-l-2 h-full border-green col-start-4 col-end-4 row-start-2 row-end-6 mr-8 "></span>
