		...
		<div className="text-white flex flex-col lg:flex-row h-full pb-10 desktop:justify-center">
			...
			<div className="px-12 pt-[213px]">
				...
				<main className="block m-16 ">
					...
					<section className="grid auto-cols-auto auto-rows-auto gap-4 mb-16 ">
						<h1 className="font-aclonica text-6xl row-start-1 row-end-2 col-start-1 col-end-7 text-center ">
							Box Meals
						</h1>
						<div className="  w-full row-start-2 row-end-3 col-start-1 col-end-4 h-auto">
							<div className="flex justify-between font-inter text-base">
								<h2>The Cypriot</h2>
								<p>£7.50</p>
							</div>
						...
						<div className="  w-full row-start-2 row-end-3 col-start-4 col-end-7 ">
							<div className="flex justify-between font-inter text-base">
								<div className="flex">
									<h2>The Greek Box &nbsp; </h2>
