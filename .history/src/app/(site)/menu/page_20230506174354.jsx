			...
			<div
				className={`${
					!media
						? "max-w-[1340px] w-full ml-auto mr-auto"
						: "max-w-[1000px] w-full ml-auto mr-auto"
				} bg-[url('/menu/menu.png')] bg-cover bg-opacity-20 `}
			>
				<div className="absolute top-0 left-0 w-full h-full mt-80 left-0 right-0 bg-red-600 opacity-20"></div>
				<div className="relative bg-[url('/menu/menu.png')] -mt-160 left-0 right-0 bg-cover"></div>
