...
const Menu = () => {
	...
	return (
		<div className="text-white block h-full pb-10 justify-center ">
			...
			>
				<nav>
					<ul className={`flex justify-between ${mobile ? "mx-40" : "mx-8" mt-16 font-inter font-extrabold`} >
						<li>
			...
			>
				<main className="block m-16 ">
					...
					>
						<h1 className="font-aclonica text-6xl row-start-1 row-end-2 col-start-1 col-end-4 text-center mb-4 pt-10">
							Souvlakis/Wraps
						</h1>
