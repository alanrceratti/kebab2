			...
			<div className="px-12 pt-[213px]">
				...
				<main className="block m-16">
					<section className="grid auto-cols-auto auto-rows-auto gap-4">
						...
						<div class="absolute right-1/2 top-0 hidden h-full min-h-[1em] w-px self-stretch border-t-0 bg-white to-transparent opacity-25 dark:opacity-100 lg:block"></div>
