		...
		<div className="text-white flex flex-col lg:flex-row h-full pb-10 desktop:justify-center">
			...
			<div className="px-12 pt-[213px]">
				...
				<main className="block m-16 ">
					<section className="grid auto-cols-auto auto-rows-auto gap-4 mb-16 ">
						<h1 className="font-aclonica text-6xl row-start-1 row-end-2 col-start-1 col-end-8 text-center ">
							Souvlakis/Wraps
						</h1>
						<div className="  w-full row-start-2 row-end-3 col-start-1 col-end-4">
						...
						<div className="  w-full row-start-3 row-end-4 col-start-1 col-end-4">
							<div className="flex justify-between font-inter text-base">
								<h2>Lamb Souvlaki</h2>
								<p>
									Small - £5.90 / Medium - £7.90 / Giant -
						...
						<div className="  w-full row-start-4 row-end-5 col-start-1 col-end-4">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-5 row-end-6 col-start-1 col-end-4">
							<div className="flex justify-between font-inter text-base">
						...
						<span className="border-l-2 h-full w-auto border-green  col-start-4 col-end-5 row-start-2 row-end-6  "></span>
						<div className="  w-full row-start-2 row-end-3 col-start-5 col-end-8 ">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-3 row-end-4 col-start-5 col-end-8">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-4 row-end-5 col-start-5 col-end-8">
							<div className="flex justify-between font-inter text-base">
						...
						<div className="  w-full row-start-5 row-end-6 col-start-5 col-end-8">
							<div className="flex justify-between font-inter text-base">
					...
					<section className="grid auto-cols-auto auto-rows-auto gap-4 mb-16 ">
						...
						<div className="  w-full row-start-3 row-end-4 col-start-1 col-end-4">
							<div className="flex justify-between font-inter text-base mr-12">
						...
						<span className="border-l-2 h-full w-auto border-green m-auto  col-start-4 col-end-5 row-start-2 row-end-4  "></span>
						<div className="  w-full row-start-2 row-end-3 col-start-5 col-end-8 ">
							<div className="flex justify-between font-inter text-base">
								<div className="flex">
									<h2>The Greek Box &nbsp; </h2>
					...
					<section className="grid auto-cols-auto auto-rows-auto gap-4 mb-16 ">
						...
						<div className="  w-full row-start-2 row-end-3 col-start-1 col-end-4  ">
							...
							<hr class="h-px my-0 bg-gray-200 border-0 w-auto dark:bg-white -mr-12" />
						</div>
						...
						<div className="  w-full row-start-3 row-end-4 col-start-1 col-end-4">
							...
							<hr class="h-px my-0 bg-gray-200 border-0 dark:bg-white -mr-12" />
						</div>
						...
						<span className="border-l-2 h-full w-auto border-green m-auto  col-start-4 col-end-5 row-start-2 row-end-6  "></span>
						<div className="  w-full row-start-2 row-end-3 col-start-5 col-end-8 ">
							<div className="flex justify-between font-inter text-base">
								<h2>Tzatziki dip</h2>
								<p>£2.00</p>
