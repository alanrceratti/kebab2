		...
		<div className="text-white block h-full pb-10 justify-center ">
			...
			>
				<main className="block m-4 md:m-16">
					...
					>
						<h1 className="font-aclonica text-4xl row-start-1 sm:row-end-2  sm:row-start-1 sm:row-end-2 sm:col-start-1 sm:col-end-4 text-center mb-4 pt-10 md:text-6xl">
							Souvlakis/Wraps
						</h1>
						<div className="  w-full sm:row-start-2 sm:row-end-3 sm:col-start-1 sm:col-end-2 ">
