		...
		<div className="text-white block h-full pb-10 justify-center ">
			...
			>
				<nav>
					...
					>
						<li>
							<a href="#1" className="cursor-pointer m-10">
								Souvlakis/Wraps
							</a>
						</li>
						<li>
							<a href="#2" className="cursor-pointer m-10 ">
								Box Meals
							</a>
						</li>
						<li>
							<a href="#3" className="cursor-pointer m-10">
								Extras/Sides
							</a>
						</li>
						<li>
							<a href="#4" className="cursor-pointer m-10">
								Drinks
							</a>
						</li>
					</ul>
