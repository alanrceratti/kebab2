...
const Menu = () => {
	return (
		<div className="text-white flex flex-col lg:flex-row h-full pb-10 desktop:justify-center">
			...
			/>
			<div className="m-auto pt-[213px] w-[1340px]">
				<h1 className=" text-6xl md:text-7xl font-aclonica -ml-56">
					Our <span className="text-green">Options</span>
				</h1>
				<nav className=" ">
					<ul className="flex justify-between mx-4 mt-16 font-inter font-extrabold ">
						<li>
