...
const Menu = () => {
	...
	return (
		<div className="text-white block h-[3000px] bg-no-repeat bg-ce bg-cover pb-10 justify-center bg-[url('/menu/menu.png')] absolute -z-10 mt-80 left-0 right-0 ml-auto mr-auto bg-opacity-30  ">
			{/* <Image
				src={menu}
				alt="menu"
