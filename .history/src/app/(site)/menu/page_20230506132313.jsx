	...
	return (
		<div className="text-white flex flex-col lg:flex-row h-full pb-10 desktop:justify-center">
			...
			<div className="px-12 pt-[213px]">
				...
				<main>
					<section className="grid grid-cols-2 grid-a m-16">
						<h1 className="font-aclonica text-6xl col-start-1 col-end-3 text-center">
							Souvlakis/Wraps
						</h1>
						<div className="flex justify-between w-1/2  col-start-1 col-end-2">
