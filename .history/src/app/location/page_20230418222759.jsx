...
const Location = () => {
	return (
		<section className="text-white ">
			...
			<div className="flex flex-col lg:grid lg:grid-cols-4 lg:grid-rows-2 pt-10">
				<div className="lg:col-start-1 lg:col-end-3 lg:row-start-1 lg:row-end-1 ml-10  ">
				...
				></iframe>
				<iframe
					className="2xl:hidden rounded-2xl m-auto "
					width={714}
					height={509}
					title="map"
					loading="lazy"
