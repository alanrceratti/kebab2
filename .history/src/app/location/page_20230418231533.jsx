					...
					<div>
						...
						<div className="font-inter 2xl:w-5/12 m-10 lg:text-lg md:text-xl ">
							<p className="before:block before:bg-green before:w-[5px] before:h-[25px] before:relative before:left-[-10px] before:top-6 mb-5">
								Visit us at our brick-and-mortar location to
								experience the vibrant flavors of Greece in a
								warm and welcoming atmosphere.
							</p>
							<p>
								Our restaurant is located in the heart of
								downtown, where you can enjoy traditional Greek
					...
					<InViewSectionLeft>
						...
						<div className="col-start-1 col-end-3 row-start-2 row-end-3 ml-10">
							...
							<p className="text-md md:text-lg w-auto mb-16">
								Monday - Thursday: 11:00am - 9:00pm<br></br>
								Friday - Saturday: 11:00am - 10:00pm<br></br>
								Sunday: Closed
							</p>
						</div>
					</InViewSectionLeft>
