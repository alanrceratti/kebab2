	...
	return (
		<section className="text-white ">
			...
			<div className="grid grid-cols-2 grid-rows-2 pt-10">
				<div className="col-start-1 col-end-2 row-start-1 row-end-1 ml-10 ">
				...
				<iframe
					width={700}
					height={500}
					className="col-start-2 col-end-3 row-start-1 row-end-3 pr-10 pb-10"
					title="mapa"
					loading="lazy"
					allowFullScreen
					src="<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2373.28129781798!2d-2.5289239229619684!3d53.49917026327752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487b03d8820d16c7%3A0xbe6b0660b55e53f4!2sGreek%20Traditional%20Eatery%20Leeds!5e0!3m2!1sen!2suk!4v1681766363112!5m2!1sen!2suk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"
				></iframe>
				<div className="col-start-1 col-end-2 row-start-2 row-end-3 ml-10">
