		...
		>
			...
			>
				...
				<Carousel
					...
					title2={"SAKA"}
					description={
						"Moussaka is a traditional Greek dish that features layers of eggplant, potatoes, and ground beef or lamb, topped with a creamy béchamel sauce and baked to perfection. The meat is seasoned with spices like "
					}
				/>
			</Splide>
		</motion.div>
