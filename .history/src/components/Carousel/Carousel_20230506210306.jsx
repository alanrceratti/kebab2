				...
				<div className="absolute top-60 left-12">
					...
					<div className="relative top-6 block gap-4 text-center ">
						...
						<div className="flex gap-8">
							<a href="https://www.just-eat.co.uk/restaurants-greek-traditional-souvlaki-leigh/menu">
								<Image
									src={justeat}
									alt="justeat"
							...
							<a href="https://deliveroo.co.uk/menu/wigan/warrington/greek-traditional-souvlaki-warrington?geohash=gcqptku59pd9"></a>
							<Image
								src={deliveroo}
								alt="justeat"
								className=" cursor-pointer"
