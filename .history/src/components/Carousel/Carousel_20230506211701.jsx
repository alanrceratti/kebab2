	...
	return (
		<SplideSlide>
			<div className="relative  text-white overflow-hidden">
				...
				<div className="absolute sm:top-60 top-40 left-6 sm:left-12">
					<h1 className="font-aclonica text-[50px] sm:text-[80px] md:text-[121px] text-white">
						{title}
						<span className="text-green">{title2}</span>
					</h1>
					<p className="text-sm md:text-xl pr-4 w-full max-w-[300px] sm:max-w-[500px]">
						{description}
					</p>

					<div className="relative top-6 w-[500px] block gap-4 text-center ">
						<Link href={"/menu"}>
