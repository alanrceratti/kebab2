			...
			<div className="relative  text-white overflow-hidden">
				...
				<div className="absolute top-60 left-12">
					...
					<div className="relative top-6 flex gap-4 ">
						...
						<Link href={'/menu'}>
							<button className="h-12 w-32 sm:h-16 sm:w-60   bg-trasparent text-white border-2 font-bold transition-all ease-in-out duration-500 hover:bg-black hover:border hover:border-2 hover:border-green hover:text-green">
								VIEW MEN
							</button>
						</Link>
					</div>
