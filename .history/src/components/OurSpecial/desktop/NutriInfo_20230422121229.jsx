						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{props.data && props.newOffers.length < !0
									...
									: props.newOffers[0]?.nutritional.saturated_fat}
								g
							</td>
						</tr>
						<tr className="border-2 text-gray-400">
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{props.data && props.newOffers.length < !0
									...
									: props.newOffers[0]?.nutritional.cholesterol}
								mg
							</td>
						</tr>
						<tr className="border-2 text-gray-400">
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{props.data && props.newOffers.length < !0
									...
									: props.newOffers[0]?.nutritional.carbohydrate}
								g
							</td>
						</tr>
						<tr className="border-l-2 text-gray-400 border-r-2">
							...
							<td className="text-right">
								{props.data && props.newOffers.length < !0
									...
									: props.newOffers[0]?.nutritional.dietary_fiber}
								g
							</td>
						</tr>
						<tr className="border-2 text-gray-400">
