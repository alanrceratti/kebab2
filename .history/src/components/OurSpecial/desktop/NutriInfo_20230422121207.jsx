					...
					<tbody>
						<tr className="border-2 text-gray-400 ">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.calories
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.saturated_fat
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.trans_fat
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.cholesterol
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.sodium
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.carbohydrate
						...
						<tr className="border-l-2 text-gray-400 border-r-2">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.dietary_fiber
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.sugar
						...
						<tr className="border-2 text-gray-400">
							...
							<td className="text-right">
								{prosp.data && newOffers.length < !0
									? prosp.data[0]?.nutritional.protein
